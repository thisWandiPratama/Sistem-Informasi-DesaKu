...
class Admin_Wisata_DesaKu extends Component {
    ...
    uploadImageToServer = () => {
        ...
        RNFetchBlob.fetch('POST', 'https://sisteminformasidesaku.000webhostapp.com/api/Wisata_DesaKu/tambah_wisata_desaku.php', {
            Authorization: "Bearer access-token",
            otherHeader: "foo",
            'Content-Type': 'multipart/form-data',
        }, [
            { name: 'image', filename: 'image.png', type: 'image/png', data: this.state.data },
            { name: 'nama_wisata_desaku', data: this.state.nama_wisata_desaku },
            { name: 'photo_wisata_desaku', data: this.state.lokasi_wisata_desaku },
            { name: 'maps_wisata_desaku', data: this.state.maps_wisata_desaku },
        ]).then((resp) => {
